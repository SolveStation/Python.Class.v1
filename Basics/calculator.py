...
# def is a keyword for defining functions
...
def multiplication():
    ...
    print(f"The result of {firstNumber} x {secondNumber} = {result}")
...
def exponentiation():
    ...
    print(f"The result of {firstNumber} raised to power {secondNumber} = {result}")
...
def floor_division():
    ...
    print(f"The result of {firstNumber} floor {secondNumber} = {result}")
...
def modulo():
    ...
    print(f"The result of {firstNumber} modulo {secondNumber} = {result}")
